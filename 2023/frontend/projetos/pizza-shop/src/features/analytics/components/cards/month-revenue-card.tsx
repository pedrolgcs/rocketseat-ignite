...
export function MonthRevenueCard() {
  const {
    data: monthRevenue,
    isLoading: isLoadingOnGetMonthRevenue,
    isError: isErrorOnGetMonthRevenue,
    refetch: refetchMonthRevenue,
  ...
  return (
    <Card>
      ...
      <CardContent>
        {isErrorOnGetMonthRevenue && <CardError retry={refetchMonthRevenue} />}

        {isLoadingOnGetMonthRevenue && <CardSkeleton />}
