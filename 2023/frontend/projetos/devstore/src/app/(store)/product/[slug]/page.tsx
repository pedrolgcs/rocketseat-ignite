...
export default async function ProductPage({ params }: ProductPage) {
  ...
  return (
    ...
    >
      ...
      <div className={cn('flex flex-1 flex-col justify-center', 'lg:px-12')}>
        ...
        <div className={cn('mt-5 space-y-4 pb-5', 'lg:mt-8 lg:p-0')}>
        ...
        <button
          type="button"
          className={cn(
            'mt-auto flex h-12 items-center justify-center rounded-full bg-emerald-600 font-semibold text-white transition-colors duration-300 hover:bg-emerald-700',
            'lg:mt-8',
          )}
        >
