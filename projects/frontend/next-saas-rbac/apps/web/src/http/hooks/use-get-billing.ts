...
export const USE_GET_ORGANIZATION_BILLING_QUERY_KEY = 'organization-billing'

export type UseGetOrganizationsQueryKey = [
  typeof USE_GET_ORGANIZATION_BILLING_QUERY_KEY,
  slug: string,
]

export function useGetBillingQuery(params: GetBillingParams) {
  return useQuery({
    queryKey: [USE_GET_ORGANIZATION_BILLING_QUERY_KEY, params.slug],
